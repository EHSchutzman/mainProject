...
//    public void displayUpgradeApproval(User user) throws Exception {
//        try {
//            Stage stage = new Stage();
//            stage.setTitle("Authentication Upgrade Review");
//            FXMLLoader loader = new FXMLLoader();
//            loader.setLocation(getClass().getResource("superAgentUpgradeReview.fxml"));
//            AnchorPane newWindow = loader.load();
