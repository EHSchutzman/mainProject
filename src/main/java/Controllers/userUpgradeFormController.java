...
public class userUpgradeFormController extends UIController{
    ...
    public void updateUpgradeInfo() {
        ArrayList<String> list = dbManager.findUpgradeRequest(super.main.userData.getUserInformation().getUid());
    ...
    public void removeUpgradeRequest(){
        dbManager.dropUpgradeRequest(super.main.userData.getUserInformation().getUid());
        updateUpgradeInfo();
    }
